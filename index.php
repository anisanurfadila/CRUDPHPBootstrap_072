            ...
            <div class="modal-content">
                <form method="post" action="create.php" name="form">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="type" class="form-control" id="NIM" placeholder="Masukan NIM Mahasiswa" name="nim" required>
                    </div>
                    
                    
                    <div class="mb-3">
                        <label for="alamat" class="form-label">Alamat</label>
                        <textarea type="text" id="Alamat" class="form-control" placeholder="Masukan alamat mahasiswa" name="alamat" rows="3" required></textarea>
                        </div>
                    </div>
